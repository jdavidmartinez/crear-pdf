...
doc.pipe(fs.createWriteStream(__dirname+'/Gaseta Compra 123 Dia de Madres V2.pdf'));
//agrega portada pdf
...
//Hoja 2
//fila 1
doc.image('images/'+arrayTest[0],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BLa%20Colinita%7D.');//.rect(coor1X,coor1Y, 510, 150).stroke();
//fila 2 de Grilla
coor1Y = 300;
doc.image('images/'+arrayTest[1],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BBianco%20Panneter%C3%ADa%7D.');//.rect(coor1X,coor1Y, 510, 150).stroke();
//fila 3 de Grilla
coor1Y = 470;
doc.image('images/'+arrayTest[2],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BBosques%20de%20Cocora%7D.');//.rect(coor1X,coor1Y, 510, 150).stroke();
...
coor1X = 60;
coor1Y = 130;
doc.image('images/'+arrayTest[3],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BBernab%C3%A9%20Gourmet%7D.');

//fila 2 de Grilla
coor1Y = 300;
doc.image('images/'+arrayTest[4],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BLineas%20de%20Nazca%7D.');
//fila 3 de Grilla
coor1Y = 470;
doc.image('images/'+arrayTest[5],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BParma%20Pizzza%7D.');
...
coor1X = 60;
coor1Y = 130;
doc.image('images/'+arrayTest[6],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s%20del%20restaurante%20%7BTrinchete%20Picnic%7D.');
//fila 2 de Grilla
coor1Y = 300;
doc.image('images/'+arrayTest[7],coor1X,coor1Y,{width:510, height:150}).link(coor1X,coor1Y, 510, 150, 'https://wa.me/573005351420?text=Hola,%20acabo%20de%20ver%20el%20men%C3%BA%20del%20d%C3%ADa%20de%20Madres%20y%20quiero%20conocer%20m%C3%A1s.');
//fila 3 de Grilla
